    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.md }}>
        ...
        <TouchableOpacity
          ...
          style={s.item}
          onPress={() => (require("expo-router").router as any).push("/planning")}
        >
          <View style={[s.iconBox, { backgroundColor: `${colors.primary}22`, borderColor: colors.primary }]}>
            <Ionicons name="grid" size={20} color={colors.primary} />
          </View>
          <View style={{ flex: 1 }}>
            <Text style={s.itemT}>PV-Layout & Stückliste</Text>
            <Text style={s.itemS}>Multi-Brand · SolarEdge · Hoymiles · Sigenergy</Text>
          </View>
          <Ionicons name="chevron-forward" size={20} color={colors.textSecondary} />
        </TouchableOpacity>
